...
import com.jpmh.curso.domain.dto.AuthenticationRequest;
import com.jpmh.curso.domain.dto.AuthenticationResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthenticationRequest request){
        try{
            ...
            UserDetails userDetails = cursoUserDetailService.loadUserByUsername(request.getUsername());
